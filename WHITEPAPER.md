...
*Whitepaper version 1.3 · status: `v0.3.0` published to npm under `@loomfsm/*` — interactive · headless · daemon · HTTP control plane · web dashboard (`loom up`) · configure-once multi-backend execution · non-Claude work-agent harnesses.*
